...
mongoose.connect(MONGODB_URI, {
  ...
  .catch(err => {
    logger.error('MongoDB connection error', {message: err.message, stack: err.stack, userId: req.user?.id || 'unknown'});
...
app.get('/api/restaurants/:id', jwtMiddleware, async (req, res) => {
  try {
    ...
    logger.error('Error in GET by id', {message: err.message, stack: err.stack, userId: req.user?.id || 'unknown'});
...
app.get('/api/restaurants/borough/:borough', async (req, res) => {
  try {
    ...
    logger.error('Error in GET by Borough', {message: err.message, stack: err.stack, userId: req.user?.id || 'unknown'});
...
app.post('/api/restaurants', async (req, res) => {
  try {
    ...
    logger.error('Error in POST', {message: err.message, stack: err.stack, userId: req.user?.id || 'unknown'});
...
app.put('/api/restaurants/:id', async (req, res) => {
  try {
    ...
    logger.error('Error in PUT', {message: err.message, stack: err.stack, userId: req.user?.id || 'unknown'});
...
app.delete('/api/restaurants/:id', async (req, res) => {
  try {
    ...
    logger.error('Error in DELETE', {message: err.message, stack: err.stack, userId: req.user?.id || 'unknown'});
...
app.get('/api/restaurants', async (req, res) => {
  try {
    ...
    logger.error('Error in GET', {message: err.message, stack: err.stack, userId: req.user?.id || 'unknown'});
